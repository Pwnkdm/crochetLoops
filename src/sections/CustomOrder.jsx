...
export const CustomOrder = () => {
  return (
    <section
      className="py-32 bg-text-primary text-primary relative overflow-hidden"
      id="custom"
    >
      ...
      <div className="container mx-auto px-6 lg:px-12 relative z-10 text-center max-w-3xl">
        ...
        >
          ...
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-serif text-white">
            ...
            <span className="italic text-accent font-light">Unique?</span>
          </h2>
          <p className="text-lg md:text-xl font-sans text-primary/80 font-light leading-relaxed max-w-xl mx-auto">
            Create personalized crochet gifts tailored perfectly to your vision.
            Whether it's a memory you want to capture or a specific design you
            have in mind, we'll bring it to life stitch by stitch.
          </p>
